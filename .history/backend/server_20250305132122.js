...
app.get('/quiz', (req, res) => res.sendFile(path.join(__dirname, '../index', 'quiz.html'))); // Thêm route cho quiz.html

// Route lấy câu hỏi từ test2.json (cho testdauvao2.html)
...
// Route lấy câu hỏi từ dethi.json (cho quiz.html)
app.get('/api/questions', (req, res) => {
    const { subject, level } = req.query;
    console.log(`Request /api/questions: subject=${subject}, level=${level}`); // Debug
