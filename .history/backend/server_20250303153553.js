...
app.post('/api/scores', async (req, res) => {
    ...
    try {
        // Chuyển studentId thành ObjectId
...
app.get('/api/scores', async (req, res) => {
    ...
    console.log(`GET /api/scores called with studentId: ${studentId}`);
    if (!studentId) {
        console.log('Thiếu studentId trong yêu cầu');
...
app.delete('/api/scores/:scoreId', async (req, res) => {
    ...
    console.log(`DELETE /api/scores/${scoreId} called`);
    try {
