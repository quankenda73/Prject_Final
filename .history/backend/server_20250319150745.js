// Import module path trước khi sử dụng
const path = require('path');

// Cấu hình dotenv với đường dẫn đến file .env
require('dotenv').config({ path: path.join(__dirname, '.env') });

// Thêm log để kiểm tra quá trình tải file .env
console.log('Thư mục hiện tại (__dirname):', __dirname);
console.log('Đường dẫn file .env:', path.join(__dirname, '.env'));
console.log('Nội dung MONGO_URI:', process.env.MONGO_URI ? process.env.MONGO_URI : 'undefined');
